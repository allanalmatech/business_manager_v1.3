<?php
// modules/documents/invoices.php
...
$page_title = "Invoices";
$page_subtitle = "View, print, and manage customer invoices";
  ...
  <div class="app-content">
    ...
    <main class="page-wrap">
      ...
      <?php
        ...
        // Filter by document type - only show invoices
        $where .= " AND s.doc_type = 'invoice'";
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-center mt-3">
            <div class="small text-muted">
              Showing <?= count($rows) ?> of <?= (int)$total ?> invoices
            </div>
