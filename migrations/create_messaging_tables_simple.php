<?php
// migrations/create_messaging_tables_simple.php
declare(strict_types=1);

// Simple database connection without bootstrap
...
try {
    ...
    if ($mysqli->query($createMessageLogs)) {
    ...
    if ($mysqli->query($createMessageTemplates)) {
    ...
    if ($mysqli->query($createMessages)) {
    ...
    if ($mysqli->query($insertTemplates)) {
